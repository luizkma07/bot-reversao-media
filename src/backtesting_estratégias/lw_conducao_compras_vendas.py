...
from utils.utilidades import ajusta_start_time, calcula_percentual_perda_na_compra, calcula_percentual_lucro_na_compra, calcula_percentual_perda_na_venda, calcula_percentual_lucro_na_venda
