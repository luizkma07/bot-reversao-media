...
vector_db = ChromaDb(collection="pdf_knowledge_base", path="tmp/chroma_pdf_knowledge_base")

knowledge = PDFKnowledgeBase(
    path="TheCandlestickTradingBibble-MunehisaHomma.pdf",
    vector_db=vector_db,
...
if __name__ == "__main__":
    ...
    serve_playground_app("10o_agente:app", reload=True)
