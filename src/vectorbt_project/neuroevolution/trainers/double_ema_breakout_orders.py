...
from vectorbt_project.neuroevolution.evolutionary_runners.double_ema_breakout_orders import DoubleEMAEvolver
from vectorbt_project.neuroevolution.trainers.base_trainer import BaseTrainer

class DoubleEMABreakoutTrainer(BaseTrainer):
    def __init__(
        self,
        symbol: str = 'BTCUSDT',
        interval: str = '15',
    ...
    def setup_evolver(self, df: pd.DataFrame) -> DoubleEMAEvolver:
        """Configura o otimizador evolutivo"""
        return DoubleEMAEvolver(
            df,
    ...
    def save_results(self, results: List[Dict[str, Any]]) -> None:
        ...
        caminho_arquivo = f"data/results/evolutionary/{now}_double_ema_orders_{self.symbol}_{self.interval}_{self.start_date}_{self.end_date}"
...
def run_evolutionary_double_ema():
    trainer = DoubleEMABreakoutTrainer()
    trainer.run()

if __name__ == "__main__":
    run_evolutionary_double_ema()