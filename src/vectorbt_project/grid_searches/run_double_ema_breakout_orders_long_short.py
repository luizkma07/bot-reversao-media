...
caminho_csv = f"data/results/grids/{now}_double_ema_breakout_orders_long_short_{simbolo}_{intervalo}_{data_inicio}_{data_fim}.csv"
...
caminho_json = f"data/results/tops/{now}_top{nro_resultados}_double_ema_breakout_orders_long_short_{simbolo}_{intervalo}_{data_inicio}_{data_fim}.json"
