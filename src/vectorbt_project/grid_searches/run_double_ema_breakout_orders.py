...
# grid_ema_curta = [5, 9, 12, 21, 30, 35]
# grid_ema_longa = [15, 48, 90, 200]
# grid_stop = [10, 17, 21]
# grid_rr = [2.3, 2.8, 3.5, 4.1]
# grid_ema_curta = [5]
# grid_ema_longa = [15]
# grid_stop = [17]
# grid_rr = [4.1]
            ...
            for rr in grid_rr:
                ...
                try:
                    ...
                    pf = vbt.Portfolio.from_orders(
                        ...
                        # slippage=0.0001,  # Slippage (diferença entre o preço de entrada e saída)
...
# print(f"\n✅ Resultados salvos em {caminho_csv} e {caminho_csv_drawdown}")
