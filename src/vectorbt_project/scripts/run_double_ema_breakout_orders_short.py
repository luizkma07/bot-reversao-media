...
def main():
    ...
    nome = "Double EMA Breakout Orders Short"
    ...
    try:
        entries, exits, stop_price, target_price = gerar_por_nome("double_ema_breakout_orders_short", df, estrategia)
        ...
        fig_plotly = plotar_grafico_velas_plotly(
            ...
            strategy_name="double_ema_breakout_orders_short", 
            simbolo=simbolo, 
            intervalo=intervalo,
            ema_curta=ema_curta,
            ema_longa=ema_longa
        )
        fig_perf = plotar_performance_plotly(pf, entries[999:], exits[999:], "double_ema_breakout_orders_short")
